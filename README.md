...
verb nobody else can use and its own starting face · 37 implants · 56 programs
· 34 deck components · 19 of all of those one of a kind, never sold, found at a place at an hour or handed over by a decision, each with a history · 28 countermeasures · 9 pieces of bench work · 12 districts, each with a mark for the faction that
...
102 appearance features · 12 districts, drawn, with a scene for every hour and 54 places in them to go and stand · 183 ambient city events, 82 of them consequences of something you decided and 12 of them rumours that stop when the thing is found · 41 manual topics · networks in six shapes · the street in four tiers and 12 ways it stops you ·
