...
# The dataclasses and the rule kinds are in `story_types`, re-exported here
# so that `threads.Stage` and `threads.CONDITIONS` keep working everywhere.
from .story_types import CONDITIONS, Choice, Posting, Stage, Thread  # noqa: F401
    ...
    Thread(
        ...
        (
            ...
            Stage('rail', 'Who was at the rail',
                  ...
                  'have seen it in a hand that is not Osei\'s.',
                  requires=('weight_closed',),
                  sets=('weight_rail',),
                  after=3,
                  where='shambles'),
        )),
