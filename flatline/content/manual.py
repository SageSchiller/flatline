...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        'thread.\n\n'
        '[warn]Reach.[/] You can only probe or crack the host you are '
        'standing on and the ones one hop from it. A scan sees further, and '
        'further still with Architecture ranks or a hunter program, and what '
        'it sees is where to walk next: [fg]connect[/] is how you get next '
        'to the rest. The map draws what you have seen and dims what you '
    ...
    Topic(
        ...
        'quarter. Needs a payload.\n'
        '  [accent]corrupt[/]     edit a record so it has always said '
        'something else. Needs a payload.\n'
        '  [accent]wipe[/]        destroy an asset in place. Loud, nothing to '
        'carry out, but it still needs a payload to do the destroying.\n'
    ...
    Topic(
        ...
        '[warn]Every piece bites.[/] Each carries a specific named drawback, in '
        'the fiction and in '
    ...
    Topic(
        ...
        'range in the city, where you can run from and what you hear, at the '
        'cost of signature. Nothing on the deck reaches into a network past '
        'the host next to you; only a scan sees further, and that is '
        'Architecture and a hunter program.\n\n'
    ...
    Topic(
        ...
        'you can type.\n\n'
        '[warn]The city moves while you do.[/] Contracts expire, heat decays, '
        'market stock '
        ...
        '\n\n'
        '[warn]The city is bigger than the twelve names on the map.[/] Every '
    ...
    Topic(
        ...
        '[warn]They can also die.[/] That is the reason the whole thing exists. A '
    ...
    Topic(
        ...
        '\n\nA fixer\'s [fg]deal <name> muscle[/] is the physical kind of work: see `help street`.',
    ...
    Topic(
        ...
        '[warn]The street has work.[/] [fg]errands[/]: carry a package a few '
        ...
        '[warn]The street can be paid.[/] [fg]arrange[/] a standing arrangement '
    ...
    Topic(
        ...
        '[warn]Coming off.[/] Five clean shifts sheds one point, and using '
        'anything at all resets '
        ...
        'completely.\n\n'
        '[warn]Timing matters twice.[/] A high that adds Focus has to be in you '
    ...
    Topic(
        ...
        'not having it.\n\n'
        '[warn]What is fixed and what is not.[/] Build, face, eyes and marks are '
        'set at creation. The other four are '
